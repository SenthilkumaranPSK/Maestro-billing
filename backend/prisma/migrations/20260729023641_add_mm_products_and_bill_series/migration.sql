...
INSERT INTO "new_bills" ("bill_date", "bill_number", "consignee_address", "consignee_gstin", "consignee_name", "created_at", "created_by", "customer_id", "deleted_at", "despatched_through", "destination", "discount_amount", "due_date", "eway_bill_no", "grand_total", "gst_amount", "gst_inclusive", "id", "irn_no", "notes", "other_reference", "payment_mode", "service_dates", "service_description", "service_from", "service_to", "status", "sub_total", "updated_at", "vehicle_no") SELECT "bill_date", "bill_number", "consignee_address", "consignee_gstin", "consignee_name", "created_at", "created_by", "customer_id", "deleted_at", "despatched_through", "destination", "discount_amount", "due_date", "eway_bill_no", "grand_total", "gst_amount", "gst_inclusive", "id", "irn_no", "notes", "other_reference", "payment_mode", "service_dates", "service_description", "service_from", "service_to", "status", "sub_total", "updated_at", "vehicle_no" FROM "bills";
DROP TABLE "bills";
